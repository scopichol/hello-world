...
PROJECT_ROOT, filename = os.path.split(__file__)
...
STATICFILES_DIRS = (
    ...
    #'D:/work/42cups/django-hello-world/django_hello_world/hello/static',
)
...
INSTALLED_APPS = (
    ...
    'django_hello_world.jquerywidgets',
    'django_hello_world.hello',
    'django_hello_world.accounts',
    'django_hello_world.requestlog',
)
